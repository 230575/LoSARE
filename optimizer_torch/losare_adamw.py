...
from .adaptive_gradient_projection import AdaptiveGradientProjector
            ...
            for p in group["params"]:
                ...
                if "rank" in group:
                    if "projector" not in state:
                        state["projector"] = AdaptiveGradientProjector(
                            rank=group["rank"],
                            update_proj_gap=group["update_proj_gap"],
                            alpha=group["alpha"],
                            proj_type=group["proj_type"],
                            adaptive_update=group["adaptive_update"],
